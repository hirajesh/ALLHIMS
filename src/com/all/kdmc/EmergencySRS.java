...
public class EmergencySRS 
{
	...
	String EmergencyUserName="nivetha";
	String EmergencyPassword="123";
	...
	public void Emergencyall() throws InterruptedException, IOException
	{
    	...
    	System.setProperty("webdriver.chrome.driver","D:\\Selenium\\New folder\\chromedriver1.exe"); 
		   
    	driver=new ChromeDriver();
		driver.manage().window().maximize();
		driver.get("http://192.168.137.1/Multihospital_New/EmergencyLogin.aspx");
		driver.findElement(By.id("txtusername")).sendKeys(EmergencyUserName);
		driver.findElement(By.id("txtpassword")).sendKeys(EmergencyPassword);
		Thread.sleep(4000);
...
System.out.println("* LOGIN TO DIVISIONAL STORE");
	...
	try {
		...
		WebElement LabRequest=driver.findElement(By.xpath("//*[@id='connector']/div[3]/aside[1]/section/ul/li[8]/a"));
	...
	Thread.sleep(2000);
	try {
		WebElement Requested_ItemLab=driver.findElement(By.xpath("//*[@id='connector']/div[3]/aside[1]/section/ul/li[8]/ul/li[1]/a")); //Requested Item Emergency
