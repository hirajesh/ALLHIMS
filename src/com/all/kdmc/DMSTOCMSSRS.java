...
//	WebDriver driver = new FirefoxDriver();
	...
	public void DMS() throws InterruptedException
	{
		...
		Thread.sleep(2000);
		driver.findElement(By.id("txtusername")).sendKeys("srsnavas");
		Thread.sleep(2000);
	...
	public void CMO() throws InterruptedException, IOException {
		...
		try {
			...
			driver.findElement(By.id("txtusername")).sendKeys("srsjana");
	...
	public void Addto_Stock() throws InterruptedException 
	{
		...
		try {
			...
			int add1=driver.findElements(By.xpath("//*[@id='itemdetails1']/tbody/tr/td[5]")).size();
			System.out.print(add);
			Thread.sleep(3000);
			driver.findElement(By.xpath("/html/body/form/div[3]/aside[2]/section/div/div[4]/div/div/div[3]/div/button")).click();
			Thread.sleep(2000);
