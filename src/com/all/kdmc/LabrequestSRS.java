...
import org.testng.annotations.AfterMethod;
	...
	public class LabrequestSRS {
		...
		public static List<StockData> stockDatas=new ArrayList<>();
		 ...
		 String LabUserName="shivani";
			String LabPassword="shivani";
			
			String CMOUserName="sridhar";
			String CMOPassword="123";
			
			String StoreUserName="nivetha";
...
//		System.setProperty("webdriver.ie.driver","E:\\Others\\IEXPLORER\\IEDriverServer_x64_3.8.0 (1)\\IEDriverServer.exe");
		...
		//	 driver.get("http://192.168.137.1/Multihospital_New/");
			...
			driver.findElement(By.id("txtusername")).sendKeys(LabUserName);
			driver.findElement(By.id("txtpassword")).sendKeys(LabPassword);
			Thread.sleep(4000);
