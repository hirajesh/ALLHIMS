...
String Doctorname[]={"VINOD","SANTHIYA","ANAS"};
int DGender[]={1,2,1};
String QUalification[]={"M.B","M.B","M.B"};
String Specilization[]={"ge","An","ge"};
String DMobilenumber[]={"9856050010","9856050011","9856050013"};
...
public void Doc() throws InterruptedException
{
	...
	Thread.sleep(2000);
driver.findElement(By.xpath("/html/body/div[2]/div/div/aside[1]/section/ul/li[6]/a")).click();
Thread.sleep(2000);	
	


for(i=0;i<=Doctorname.length-1;i++)
{
...
hospital.selectByVisibleText("SRSHOSPITAL");
