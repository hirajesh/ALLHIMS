...
public class HospitalHealthpostDispensaryAndAdmin {
		...
		String date1,dat;
		String Hospitalname = "SRS HOSPITAL"; // Giva a name without space because empty space not allowed											
		String Healthpostname = "SRS HEALTHPOST";
		String Dispensaryname = "SRS DISPENSARY";
		//String ademail;
		String ademail="biju";

		String Hospitalnameemail = "SRSHOSPITAL@gmail.com".toLowerCase(); 											
		String Healthpostnameemail = "SRSHEALTHPOST@gmail.com".toLowerCase();
		String Dispensarynameemail = "SRSDISPENSARY@gmail.com".toLowerCase();

		

		String Hospital_adminname = "BIJU", HOS_ADMIN_MNUMBER = "8881277774";
		String Healthpost_adminname = "RICKY", HEL_ADMIN_MNUMBER = "8887777789";
		String Dispensary_adminname = "SMITH", DIS_ADMIN_MNUMBER = "8887777770";
		...
		// DELETE FUNCTION
		Statement St;
		String Hospital = "delete from Mstr_MultipleHospital where Hospital_Name='BSRHOSPITAL'";
		String Healthpost = "delete from Mstr_MultipleHospital where Hospital_Name='BSRHEALTHPOST'";
		String Dispensary = "delete from Mstr_MultipleHospital where Hospital_Name='BSRDISPENSARY'";
		String Hospitaladmin = "delete from mstr_Employee where Name='BIJU'";
		...
		String Delhealthpostname = "delete from Mstr_HealthpostReg where HealthpostName='BSRHEALTHPOST'";
		String Deldispensaryname = "delete from Mstr_DispensaryReg where Dispensaryname='BSRDISPENSARY'";
		...
		public void Hospital() throws InterruptedException, IOException {
			...
			try {
				...
				String Hname = Hospitalname.substring(0, 3).toLowerCase().trim();
				String mail = "@gmail.com";
				String HOS = Hname.concat(mail).trim();
				driver.findElement(By.id("txtemail")).sendKeys(Hospitalnameemail);

				driver.findElement(By.id("btnsave")).click();
				Thread.sleep(3000);
				   
				Hospital_Alert_msg=driver.findElement(By.xpath("/html/body/div[8]/div/div/div[1]/div")).getText().toString();///html/body/div[6]/div/div/div[1]/div
				System.out.println("* Hospital Alert Msg :" +Hospital_Alert_msg+ " *");
				driver.findElement(By.xpath("/html/body/div[8]/div/div/div[2]/button")).click();///html/body/div[6]/div/div/div[2]/button
				Thread.sleep(3000);
		...
		public void Healthpost() throws InterruptedException, IOException {
			try {
				...
				//String Hpostname = Healthpostname.toLowerCase();
				
				driver.findElement(By.id("txtemail")).sendKeys(Healthpostnameemail);
		...
		public void Dispensary() throws InterruptedException, IOException {
			try {
				...
				driver.findElement(By.id("txtemail")).sendKeys(Dispensarynameemail);
		...
		public void Hospital_Admin() throws InterruptedException, IOException {
			...
			//		driver.findElement(By.cssSelector("#ui-datepicker-div > div > a.ui-datepicker-prev.ui-corner-all")).click();
				...
				try {
					...
					try {
						Hospital_Admin_Alert_msg=driver.findElement(By.xpath("/html/body/div[7]/div/div/div[1]/div")).getText().toString();
					} catch (Exception e) {
						// TODO Auto-generated catch block
					//	e.printStackTrace();
						Thread.sleep(3000);
		...
		public void Healthpost_Admin() throws InterruptedException, IOException {
			...
			System.out.println("==============================");
				...
				try {
					...
					System.out.println("* Healthpost Admin Alert Msg :" +Hospital_Admin_Alert_msg+ " *");
					driver.findElement(By.xpath("/html/body/div[7]/div/div/div[2]/button")).click();
		...
		public void Dispensary_Admin() throws InterruptedException, IOException {
			...
			System.out.println("===============================");
				...
				try {
					...
					System.out.println("* Dispensary Admin Alert Msg :" +Hospital_Admin_Alert_msg+ " *");
					driver.findElement(By.xpath("/html/body/div[7]/div/div/div[2]/button")).click();
