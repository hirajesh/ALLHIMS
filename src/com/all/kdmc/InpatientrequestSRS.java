...
public class InpatientrequestSRS {
	...
	String InpatientUserName="brintha";
	String InpatientPassword="123";
	...
	public void openbrowser() throws InterruptedException, IOException {
	   ...
	   driver = new ChromeDriver();
		...
		driver.findElement(By.id("txtusername")).sendKeys(InpatientUserName);
		driver.findElement(By.id("txtpassword")).sendKeys(InpatientPassword);
...
public void DMS() throws InterruptedException, IOException {
	...
	public void Inpatient_ack() throws InterruptedException
	{
		...
		try {
			driver.findElement(By.linkText("In Patient")).click();
			driver.findElement(By.id("txtusername")).sendKeys("fwvijay");
